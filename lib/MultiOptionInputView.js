...
/**
 * An input view for checkboxes and radio groups allowing multiple values to be selected
...
module.exports = require('view').extend({
  ...
  onClick: function(event) {
    ...
    this.emit('change'); //only emit if the value has actually changed. when IE8 dies we should probably use the dom change event
  }
